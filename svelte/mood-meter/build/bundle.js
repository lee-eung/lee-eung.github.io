...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = "https://loggialab.kr/img/woman.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "width", "20px");
    			attr_dev(img, "alt", "");
    			add_location(img, file, 68, 3, 2232);
    			...
    			attr_dev(div0, "class", "svelte-ev1u68");
    			add_location(div0, file, 63, 2, 2029);
    			attr_dev(div1, "class", "mood-meter svelte-ev1u68");
    			add_location(div1, file, 62, 0, 1984);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "dragstart", /*startDragging*/ ctx[3], false, false, false),
    					listen_dev(div0, "drag", /*continueDragging*/ ctx[4], false, false, false),
    					listen_dev(div0, "dragend", /*finishDragging*/ ctx[5], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let Arena, DragImage;
    	let X = 20, DeltaX;
    	const minX = 0, maxX = 1114 - 40;
    	let Y = 20, DeltaY;
    	const minY = 0, maxY = 837 - 65;
    	...
    	function continueDragging(Event) {
    		if (Event.screenX === 0 && Event.screenY === 0 && !PositioningWasDelayed) {
    			...
    			let localPosition = svelteCoordinateConversion.fromDocumentTo(
    				'local',
    				{
    			...
    			$$invalidate(1, X = Math.max(minX, Math.min(maxX, localPosition.left)));
    			$$invalidate(2, Y = Math.max(minY, Math.min(maxY, localPosition.top)));
    		}
    	...
    	$$self.$capture_state = () => ({
    		Conversion: svelteCoordinateConversion,
    		Arena,
    		DragImage,
    		X,
    		DeltaX,
    	...
    	$$self.$inject_state = $$props => {
    		if ('Arena' in $$props) $$invalidate(0, Arena = $$props.Arena);
    		if ('DragImage' in $$props) DragImage = $$props.DragImage;
    		if ('X' in $$props) $$invalidate(1, X = $$props.X);
    		if ('DeltaX' in $$props) DeltaX = $$props.DeltaX;
    		if ('Y' in $$props) $$invalidate(2, Y = $$props.Y);
    		if ('DeltaY' in $$props) DeltaY = $$props.DeltaY;
    		if ('PositioningWasDelayed' in $$props) PositioningWasDelayed = $$props.PositioningWasDelayed;
    	};
    	...
    	return [Arena, X, Y, startDragging, continueDragging, finishDragging, div1_binding];
    }
